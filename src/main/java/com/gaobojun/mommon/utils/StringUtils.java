package com.gaobojun.mommon.utils;
...
public class StringUtils {
	...
	public static String toHtml(String src) {
		String replaceAll1 = src.replaceAll("\r\n", "\n");
		String replaceAll = replaceAll1.replaceAll("\r", "<br/>");
		String[] strings = replaceAll.split("\\\n");
		StringBuilder sb = new StringBuilder();
		for (String string : strings) {
			sb.append("<p>").append(string).append("</p>").append("\n");
		}
		return sb.toString();
	}
